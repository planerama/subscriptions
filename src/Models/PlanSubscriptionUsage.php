...
class PlanSubscriptionUsage extends Model
{
     ...
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function scopeByFeatureName(Builder $builder, string $name): Builder
    {
        $locale = config("app.locale");
        $feature = app('rinvex.subscriptions.plan_feature')->where("name->$locale", $name)->first();
        dump($this->feature_id);
        return $builder->where('feature_id', $this->feature_id);
    }
